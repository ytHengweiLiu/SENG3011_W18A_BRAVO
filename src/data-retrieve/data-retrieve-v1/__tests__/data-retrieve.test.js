...
describe('NBA Stats Retrieval Lambda Tests', () => {
  ...
  it('should handle invalid JSON data', async () => {
    ...
    expect(JSON.parse(response.body).details).toMatch(
      /Unterminated string in JSON at position \d+/
    )
  })
  ...
  it('should handle non-ADAGE formatted data', async () => {
    ...
    // Non-ADAGE format should still be ok - may need to change test later
    expect(response.statusCode).toEqual(200)
